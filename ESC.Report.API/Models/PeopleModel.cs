...
namespace ESC.Resturant.Domain.Models
{
    public class PeopleModel
    {
        ...
        public virtual ICollection<PeopleAccountModel> PeopleAccounts { get; set; }
        public virtual ICollection<BoxMoneisModel> BoxMonies { get; set; }
        public virtual PeopleCategoriesModel PeopleCategory { get; set; }
        public virtual PeopleTypesModel PeopleType { get; set; }
    }
}
